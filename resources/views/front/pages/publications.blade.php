...
@section('content')
    ...
    <div class="content">
        <main class="publications">
            <div class="publications__main-content main-content">
                <div class="publications__news news">
                    <h2 class="news__title">Что почитать на сайте</h2>
                    <ul class="news__list">
                    ...
                    <div class="publications__pagination pagination">
            ...
            <aside class="publications__aside aside">
                ...
                <div class="aside__forum-publication forum-publication">
                    <div class="forum-publication__wrapper">
                        <h4 class="forum-publication__title aside__title">Новости о животных</h4>
                        <ul class="forum-publication__list">
                            ...
                            <li class="forum-publication__item">
                                <a href="" class="forum-publication__forum-go-link link">Все новости</a>
                            </li>
                        </ul>
                    </div>
                </div>
